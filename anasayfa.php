<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
			<?php
			$BannerSorgusu		=	$Connection->prepare("SELECT * FROM bannerlar WHERE BannerAlani = 'Ana Sayfa' ORDER BY GosterimSayisi ASC LIMIT 1");
			...
			<?php
			// $BannerGuncelle		=	$Connection->prepare("UPDATE bannerlar SET GosterimSayisi=GosterimSayisi+1 WHERE id = ? LIMIT 1");
	...
	<tr>
		<td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr><?php
				$EnYeniUrunlerSorgusu		=	$Connection->prepare("SELECT * FROM urunler WHERE Durumu = '1' ORDER BY id DESC LIMIT 5");
	...
	<tr>
		<td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr><?php
				$EnPopulerUrunlerSorgusu		=	$Connection->prepare("SELECT * FROM urunler WHERE Durumu = '1' ORDER BY GoruntulenmeSayisi DESC LIMIT 5");
	...
	<tr>
		<td><table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr><?php
				$EnCokSatanUrunlerSorgusu		=	$Connection->prepare("SELECT * FROM urunler WHERE Durumu = '1' ORDER BY ToplamSatisSayisi DESC LIMIT 5");

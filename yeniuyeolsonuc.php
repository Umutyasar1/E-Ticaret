	...
	if($GelenSozlesmeOnay==0){
		...
		if($GelenSifre!=$GelenSifreTekrar){
			...
			if($KullaniciSayisi>0){
				...
				$UyeEklemeSorgusu		=	$Connection->prepare("INSERT INTO uyeler (EmailAdresi, Sifre, IsimSoyisim, TelefonNumarasi, Cinsiyet, Durumu, KayitTarihi, KayitIpAdresi, AktivasyonKodu) values (?, ?, ?, ?, ?, ?, ?, ?, ?)");

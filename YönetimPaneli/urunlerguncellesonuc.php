...
if(isset($_SESSION["Yonetici"])){
	...
	if(($GelenUrunMenusu!="") and ($GelenUrunAdi!="") and ($GelenUrunFiyati!="") and ($GelenParaBirimi!="") and ($GelenKdvOrani!="") and ($GelenKargoUcreti!="") and ($GelenUrunAciklamasi!="") and ($GelenVaryantBasligi!="") and ($GelenVaryantAdi1!="") and ($GelenStokAdedi1!="")){
		$UrunSorgusu	=	$Connection->prepare("SELECT * FROM urunler WHERE id = ? LIMIT 1");
		$UrunSorgusu->execute([$GelenID]);
		$UrunKontrol	=	$UrunSorgusu->rowCount();
		$UrunBilgisi	=	$UrunSorgusu->fetch(PDO::FETCH_ASSOC);
		
		if($UrunKontrol>0){
			$MenuTuruSorgusu		=	$Connection->prepare("SELECT * FROM menuler WHERE id = ? LIMIT 1");
			...
			if($MenuTuruKontrol>0){
				$UrunGuncellemeSorgusu		=	$Connection->prepare("UPDATE urunler SET MenuId = ?, UrunAdi = ?, UrunFiyati = ?, ParaBirimi = ?, KdvOrani = ?, UrunAciklamasi = ?, VaryantBasligi = ?, KargoUcreti = ? WHERE id = ? LIMIT 1");
						...
						if($BirinciResimYukle->uploaded){
						   ...
						   $BirinciResimYukle->process($VerotIcinKlasorYolu.$ResimKlasoru);
							...
							if($BirinciResimYukle->processed){
								...
								$BirinciResimGuncellemeSorgusu	=	$Connection->prepare("UPDATE urunler SET UrunResmiBir = ? WHERE id = ? LIMIT 1");
						...
						if($IkinciResimYukle->uploaded){
						   ...
						   $IkinciResimYukle->process($VerotIcinKlasorYolu.$ResimKlasoru);
							...
							if($IkinciResimYukle->processed){
								...
								$IkinciResimGuncellemeSorgusu	=	$Connection->prepare("UPDATE urunler SET UrunResmiIki = ? WHERE id = ? LIMIT 1");
						...
						if($UcuncuResimYukle->uploaded){
						   ...
						   $UcuncuResimYukle->process($VerotIcinKlasorYolu.$ResimKlasoru);
							...
							if($UcuncuResimYukle->processed){
								...
								$UcuncuResimGuncellemeSorgusu	=	$Connection->prepare("UPDATE urunler SET UrunResmiUc = ? WHERE id = ? LIMIT 1");
						...
						if($DorduncuResimYukle->uploaded){
						   ...
						   $DorduncuResimYukle->process($VerotIcinKlasorYolu.$ResimKlasoru);
							...
							if($DorduncuResimYukle->processed){
								...
								$DorduncuResimGuncellemeSorgusu	=	$Connection->prepare("UPDATE urunler SET UrunResmiDort = ? WHERE id = ? LIMIT 1");
				...
				$VaryantlarSorgusu	=	$Connection->prepare("SELECT * FROM urunvaryantlari WHERE UrunId = ?");
				...
				if(array_key_exists(0, $VaryantIsimDizisi)){
					if(($GelenVaryantAdi1!="") and ($GelenStokAdedi1!="")){
						$BirinciVaryantGuncellemeSorgusu	=	$Connection->prepare("UPDATE urunvaryantlari SET VaryantAdi = ?, StokAdedi = ? WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
				...
				if(array_key_exists(1, $VaryantIsimDizisi)){
					if(($GelenVaryantAdi2!="") and ($GelenStokAdedi2!="")){
						$IkinciVaryantGuncellemeSorgusu	=	$Connection->prepare("UPDATE urunvaryantlari SET VaryantAdi = ?, StokAdedi = ? WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
						...
						$IkinciVaryantSilmeSorgusu		=	$Connection->prepare("DELETE FROM urunvaryantlari WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
					...
					if(($GelenVaryantAdi2!="") and ($GelenStokAdedi2!="")){
						$IkinciVaryantEklemeSorgusu		=	$Connection->prepare("INSERT INTO urunvaryantlari (UrunId, VaryantAdi, StokAdedi) values (?, ?, ?)");
				...
				if(array_key_exists(2, $VaryantIsimDizisi)){
					if(($GelenVaryantAdi3!="") and ($GelenStokAdedi3!="")){
						$UcuncuVaryantGuncellemeSorgusu	=	$Connection->prepare("UPDATE urunvaryantlari SET VaryantAdi = ?, StokAdedi = ? WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
						...
						$UcuncuVaryantSilmeSorgusu		=	$Connection->prepare("DELETE FROM urunvaryantlari WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
					...
					if(($GelenVaryantAdi3!="") and ($GelenStokAdedi3!="")){
						$UcuncuVaryantEklemeSorgusu		=	$Connection->prepare("INSERT INTO urunvaryantlari (UrunId, VaryantAdi, StokAdedi) values (?, ?, ?)");
				...
				if(array_key_exists(3, $VaryantIsimDizisi)){
					if(($GelenVaryantAdi4!="") and ($GelenStokAdedi4!="")){
						$DorduncuVaryantGuncellemeSorgusu	=	$Connection->prepare("UPDATE urunvaryantlari SET VaryantAdi = ?, StokAdedi = ? WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
						...
						$DorduncuVaryantSilmeSorgusu		=	$Connection->prepare("DELETE FROM urunvaryantlari WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
					...
					if(($GelenVaryantAdi4!="") and ($GelenStokAdedi4!="")){
						$DorduncuVaryantEklemeSorgusu		=	$Connection->prepare("INSERT INTO urunvaryantlari (UrunId, VaryantAdi, StokAdedi) values (?, ?, ?)");
				...
				if(array_key_exists(4, $VaryantIsimDizisi)){
					if(($GelenVaryantAdi5!="") and ($GelenStokAdedi5!="")){
						$BesinciVaryantGuncellemeSorgusu	=	$Connection->prepare("UPDATE urunvaryantlari SET VaryantAdi = ?, StokAdedi = ? WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
						...
						$BesinciVaryantSilmeSorgusu		=	$Connection->prepare("DELETE FROM urunvaryantlari WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
					...
					if(($GelenVaryantAdi5!="") and ($GelenStokAdedi5!="")){
						$BesinciVaryantEklemeSorgusu		=	$Connection->prepare("INSERT INTO urunvaryantlari (UrunId, VaryantAdi, StokAdedi) values (?, ?, ?)");
				...
				if(array_key_exists(5, $VaryantIsimDizisi)){
					if(($GelenVaryantAdi6!="") and ($GelenStokAdedi6!="")){
						$AltinciVaryantGuncellemeSorgusu	=	$Connection->prepare("UPDATE urunvaryantlari SET VaryantAdi = ?, StokAdedi = ? WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
						...
						$AltinciVaryantSilmeSorgusu		=	$Connection->prepare("DELETE FROM urunvaryantlari WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
					...
					if(($GelenVaryantAdi6!="") and ($GelenStokAdedi6!="")){
						$AltinciVaryantEklemeSorgusu		=	$Connection->prepare("INSERT INTO urunvaryantlari (UrunId, VaryantAdi, StokAdedi) values (?, ?, ?)");
				...
				if(array_key_exists(6, $VaryantIsimDizisi)){
					if(($GelenVaryantAdi7!="") and ($GelenStokAdedi7!="")){
						$YedinciVaryantGuncellemeSorgusu	=	$Connection->prepare("UPDATE urunvaryantlari SET VaryantAdi = ?, StokAdedi = ? WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
						...
						$YedinciVaryantSilmeSorgusu		=	$Connection->prepare("DELETE FROM urunvaryantlari WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
					...
					if(($GelenVaryantAdi7!="") and ($GelenStokAdedi7!="")){
						$YedinciVaryantEklemeSorgusu		=	$Connection->prepare("INSERT INTO urunvaryantlari (UrunId, VaryantAdi, StokAdedi) values (?, ?, ?)");
				...
				if(array_key_exists(7, $VaryantIsimDizisi)){
					if(($GelenVaryantAdi8!="") and ($GelenStokAdedi8!="")){
						$SekizinciVaryantGuncellemeSorgusu	=	$Connection->prepare("UPDATE urunvaryantlari SET VaryantAdi = ?, StokAdedi = ? WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
						...
						$SekizinciVaryantSilmeSorgusu		=	$Connection->prepare("DELETE FROM urunvaryantlari WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
					...
					if(($GelenVaryantAdi8!="") and ($GelenStokAdedi8!="")){
						$SekizinciVaryantEklemeSorgusu		=	$Connection->prepare("INSERT INTO urunvaryantlari (UrunId, VaryantAdi, StokAdedi) values (?, ?, ?)");
				...
				if(array_key_exists(8, $VaryantIsimDizisi)){
					if(($GelenVaryantAdi9!="") and ($GelenStokAdedi9!="")){
						$DokuzuncuVaryantGuncellemeSorgusu	=	$Connection->prepare("UPDATE urunvaryantlari SET VaryantAdi = ?, StokAdedi = ? WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
						...
						$DokuzuncuVaryantSilmeSorgusu		=	$Connection->prepare("DELETE FROM urunvaryantlari WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
					...
					if(($GelenVaryantAdi9!="") and ($GelenStokAdedi9!="")){
						$DokuzuncuVaryantEklemeSorgusu		=	$Connection->prepare("INSERT INTO urunvaryantlari (UrunId, VaryantAdi, StokAdedi) values (?, ?, ?)");
				...
				if(array_key_exists(9, $VaryantIsimDizisi)){
					if(($GelenVaryantAdi10!="") and ($GelenStokAdedi10!="")){
						$OnuncuVaryantGuncellemeSorgusu	=	$Connection->prepare("UPDATE urunvaryantlari SET VaryantAdi = ?, StokAdedi = ? WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
						...
						$OnuncuVaryantSilmeSorgusu		=	$Connection->prepare("DELETE FROM urunvaryantlari WHERE UrunId = ? AND VaryantAdi = ? LIMIT 1");
					...
					if(($GelenVaryantAdi10!="") and ($GelenStokAdedi10!="")){
						$OnuncuVaryantEklemeSorgusu		=	$Connection->prepare("INSERT INTO urunvaryantlari (UrunId, VaryantAdi, StokAdedi) values (?, ?, ?)");

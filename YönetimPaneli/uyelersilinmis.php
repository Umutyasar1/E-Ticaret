...
if(isset($_SESSION["Yonetici"])){
	...
	$ToplamKayitSayisiSorgusu				=	$Connection->prepare("SELECT * FROM uyeler WHERE SilinmeDurumu = ? $AramaKosulu ORDER BY id DESC");
...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<?php
	$UyelerSorgusu		=	$Connection->prepare("SELECT * FROM uyeler WHERE SilinmeDurumu = ? $AramaKosulu ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SayfaBasinaGosterilecekKayitSayisi");

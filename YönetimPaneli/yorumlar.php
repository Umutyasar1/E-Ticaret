...
if(isset($_SESSION["Yonetici"])){
	...
	$ToplamKayitSayisiSorgusu				=	$Connection->prepare("SELECT * FROM yorumlar ORDER BY id DESC");
...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<?php
	$YorumlarSorgusu		=	$Connection->prepare("SELECT * FROM yorumlar ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SayfaBasinaGosterilecekKayitSayisi");

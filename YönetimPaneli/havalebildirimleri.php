...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<?php
	$BildirimSorgusu		=	$Connection->prepare("SELECT * FROM havalebildirimleri ORDER BY IslemTarihi ASC");
	...
	if($BildirimSayisi>0){
		foreach($BildirimKayitlari as $Bildirimler){
			$BankaSorgusu		=	$Connection->prepare("SELECT * FROM bankahesaplarimiz WHERE id = ? LIMIT 1");

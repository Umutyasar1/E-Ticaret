...
if(isset($_SESSION["Yonetici"])){
	...
	$ToplamKayitSayisiSorgusu				=	$Connection->prepare("SELECT * FROM urunler WHERE Durumu = ? $AramaKosulu ORDER BY id DESC");
...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<?php
	$UrunlerSorgusu		=	$Connection->prepare("SELECT * FROM urunler WHERE Durumu = ? $AramaKosulu ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SayfaBasinaGosterilecekKayitSayisi");
	...
	if($UrunlerSayisi>0){
		foreach($UrunlerKayitlari as $Urunler){
			$UrununMenuSorgusu		=	$Connection->prepare("SELECT * FROM menuler WHERE id = ? LIMIT 1");

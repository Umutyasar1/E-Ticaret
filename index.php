...
<body>
	<table width="1065" height="100%" align="center" border="0" cellpadding="0" cellspacing="0">
		<tr height="40" bgcolor="#353745">
			<td><img src="Resimler/HeaderMesajResmi.jpg" border="0" width="1065px" height="100px"></td>
		</tr>
		<tr height="110">
			...
			<table width="1065" height="80" align="center" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td width="192"><a href="index.php"><img style="width: 150px;" src="Resimler/<?php echo DonusumleriGeriDondur($SiteLogosu); ?>" border="0"></a></td>
					<td>
						<table width="873" height="30" align="center" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="306" class="AnaMenu">&nbsp;</td>
								<td width="130" class="AnaMenu"><a href="index.php">Ana Sayfa</a></td>
								<td width="170" class="AnaMenu"><a href="index.php?SK=84">Erkek Montları</a></td>
								<td width="170" class="AnaMenu"><a href="index.php?SK=85">Kadın Montları</a></td>
								<td width="140" class="AnaMenu"><a href="index.php?SK=86">Erkek Pantolonları</a></td>
                                <td width="150" class="AnaMenu"><a href="index.php?SK=87">Kadın Pantolonları</a></td>
                                <td width="150" class="AnaMenu"><a href="index.php?SK=88">Erkek <br/> T-Shirt</a></td>
                                <td width="150" class="AnaMenu"><a href="index.php?SK=89">Kadın <br/>T-Shirt</a></td>
							</tr>
						</table>
					</td>
				</tr>
